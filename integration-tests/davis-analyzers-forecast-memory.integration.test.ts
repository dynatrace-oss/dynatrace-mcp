/**
 * Integration test for Davis Analyzers - Memory Usage Forecasting
 *
 * This test verifies the Davis analyzer functionality by making actual API calls
...
describe('Davis Analyzers - Memory Usage Forecasting Integration Tests', () => {
  ...
  test('should execute forecast analyzer for memory usage', async () => {
    ...
    const forecastInput = {
      ...
      forecastHorizon: 12, // Forecast 12 hours ahead
    };
