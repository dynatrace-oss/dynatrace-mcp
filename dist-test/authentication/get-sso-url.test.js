...
describe('getSSOUrl', () => {
  ...
  it('should return SSO URL from environment variable if set', async () => {
    ...
    const result = await (0, get_sso_url_1.getSSOUrl)('https://abc12345.live.dynatrace.com');
  ...
  it('should handle sprint environment SSO URL', async () => {
    ...
    const result = await (0, get_sso_url_1.getSSOUrl)('https://abc12345.sprint.dynatracelabs.com');
  ...
  it('should handle dev environment SSO URL', async () => {
    ...
    const result = await (0, get_sso_url_1.getSSOUrl)('https://abc12345.dev.dynatracelabs.com');
