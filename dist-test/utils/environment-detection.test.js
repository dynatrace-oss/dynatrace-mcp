...
const environment_detection_1 = require('./environment-detection');
describe('isRunningInCodespaces', () => {
  ...
  it('should return true when both CODESPACE_NAME and GITHUB_CODESPACES_PORT_FORWARDING_DOMAIN are set', () => {
    ...
    expect((0, environment_detection_1.isRunningInCodespaces)()).toBe(true);
  });
  it('should return false when CODESPACE_NAME is missing', () => {
    process.env.GITHUB_CODESPACES_PORT_FORWARDING_DOMAIN = 'app.github.dev';
    // CODESPACE_NAME is not set
    expect((0, environment_detection_1.isRunningInCodespaces)()).toBe(false);
  });
...
describe('getCodespacesForwardedUrl', () => {
  ...
  it('should return the correct forwarded URL when running in Codespaces', () => {
    process.env.CODESPACE_NAME = 'my-codespace';
    process.env.GITHUB_CODESPACES_PORT_FORWARDING_DOMAIN = 'app.github.dev';
    const result = (0, environment_detection_1.getCodespacesForwardedUrl)(8080);
  ...
  it('should handle different port numbers correctly', () => {
    ...
    expect((0, environment_detection_1.getCodespacesForwardedUrl)(3000)).toBe(
      'https://test-codespace-3000.preview.app.github.dev',
    );
    expect((0, environment_detection_1.getCodespacesForwardedUrl)(5344)).toBe(
      'https://test-codespace-5344.preview.app.github.dev',
    );
    expect((0, environment_detection_1.getCodespacesForwardedUrl)(9999)).toBe(
      'https://test-codespace-9999.preview.app.github.dev',
    );
  });
  ...
  it('should handle different domain formats', () => {
    ...
    const result = (0, environment_detection_1.getCodespacesForwardedUrl)(4000);
