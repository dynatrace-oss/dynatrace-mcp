...
exports.isRunningInCodespaces = isRunningInCodespaces;
exports.getCodespacesForwardedUrl = getCodespacesForwardedUrl;
/**
 * Detects if the application is running in GitHub Codespaces
 * @returns true if running in Codespaces, false otherwise
 */
function isRunningInCodespaces() {
 ...
 */
function getCodespacesForwardedUrl(port) {
