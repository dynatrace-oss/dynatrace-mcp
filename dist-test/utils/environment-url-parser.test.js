...
const environment_url_parser_1 = require('./environment-url-parser');
describe('parseEnvironmentUrl', () => {
  it('should parse production environment URL (apps.dynatrace.com)', () => {
    const result = (0, environment_url_parser_1.parseEnvironmentUrl)('https://abc12345.apps.dynatrace.com');
    expect(result).toEqual({ environmentId: 'abc12345', stage: 'prod' });
  });
  it('should parse sprint environment URL', () => {
    const result = (0, environment_url_parser_1.parseEnvironmentUrl)('https://abc12345.sprint.apps.dynatracelabs.com');
    expect(result).toEqual({ environmentId: 'abc12345', stage: 'sprint' });
  });
  it('should parse dev environment URL', () => {
    const result = (0, environment_url_parser_1.parseEnvironmentUrl)('https://def67890.dev.apps.dynatracelabs.com');
  ...
  it('should handle invalid URL gracefully', () => {
    const result = (0, environment_url_parser_1.parseEnvironmentUrl)('not-a-valid-url');
    expect(result).toEqual({ environmentId: 'unknown', stage: 'unknown' });
  });
  it('should handle empty string gracefully', () => {
    const result = (0, environment_url_parser_1.parseEnvironmentUrl)('');
    expect(result).toEqual({ environmentId: 'unknown', stage: 'unknown' });
  });
});
describe('createNotebooksURL', () => {
  it('should create a valid Notebooks URL with a simple query', () => {
    ...
    const result = (0, environment_url_parser_1.createNotebooksURL)(environmentUrl, query);
